...
pred_cup_1 = predict.SuperLearner(object = sl_cup_1_final, newdata = test_input_cup, onlySL = TRUE)
pred_cup_2 = predict.SuperLearner(object = sl_cup_2_final, newdata = test_input_cup, onlySL = TRUE)
###
